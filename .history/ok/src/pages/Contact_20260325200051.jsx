...
const JobApplicationForm = () => {
  ...
  const WHATSAPP_NUMBER = "9911577652";
          ...
          <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row justify-between items-center text-xs text-gray-500 gap-2">
              <span>
                ...
                Your details will be shared with recruiter on WhatsApp +91 {WHATSAPP_NUMBER}
              </span>
              <span>
                <i className="fas fa-paperclip text-blue-500 mr-1"></i>
                Resume to be attached manually in WhatsApp
              </span>
            </div>
          </div>
        </div>
